...
const Toggle = dynamic(() => import("../ToogleTheme/ThemeToggle"), { ssr: false, });

const Nav = () => {
  return (
    <nav className="p-3 fixed z-20 bg-gray-300 dark:bg-black w-full">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <button
          ...
          type="button"
          className="inline-flex justify-center items-center ml-3 text-gray-400 rounded-lg md:hidden hover:text-gray-900   focus:ring-blue-300 dark:text-gray-400 dark:hover:text-white dark:focus:ring-gray-500"
